...
(function (TurbulenzAcl) {
    ...
    var SpriteLoadingService = (function () {
        function SpriteLoadingService(draw2D, graphicsDevice, observer) {
            this.draw2D = draw2D;
        ...
        SpriteLoadingService.prototype.loadAll = function () {
            this.loadTexture("Sky");
        };
        SpriteLoadingService.prototype.createSprite = function (texture) {
        ...
        SpriteLoadingService.prototype.loadTexture = function (name) {
        ...
        return SpriteLoadingService;
    })();
    TurbulenzAcl.SpriteLoadingService = SpriteLoadingService;    
})(TurbulenzAcl || (TurbulenzAcl = {}));
//@ sourceMappingURL=SpriteRepository.js.map
