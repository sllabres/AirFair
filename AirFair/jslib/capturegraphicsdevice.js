...
var CaptureGraphicsDevice = (function () {
    ...
    CaptureGraphicsDevice.prototype._lowerBound = function (bin, data, length, comp, config) {
        var first = 0;
    ...
    CaptureGraphicsDevice.prototype._compareFloatArrays = function (a, b, length, positiveThreshold) {
    ...
    CaptureGraphicsDevice.prototype._compareGenericArrays = function (a, b, length, offset) {
        var n = offset;
        var av, bv;
        while(n < length) {
            av = a[n];
